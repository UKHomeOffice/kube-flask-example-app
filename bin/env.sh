...
case ${DRONE_DEPLOY_TO} in
  ...
  'acp-prod')
    export APP_HOST_EXTERNAL="my-app.acp-example.homeoffice.gov.uk"
    export APP_HOST_INTERNAL="my-app.internal.acp-example.homeoffice.gov.uk"
  ...
  'acp-test')
    export APP_HOST_EXTERNAL="my-app.acp-example-testing.homeoffice.gov.uk"
    export APP_HOST_INTERNAL="my-app.internal.acp-example-testing.homeoffice.gov.uk"
